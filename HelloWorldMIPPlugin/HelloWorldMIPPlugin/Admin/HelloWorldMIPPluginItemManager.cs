...
namespace HelloWorldMIPPlugin.Admin
{
    /// <summary>
    ...
    /// </summary>
    public class HelloWorldMIPPluginItemManager : ItemManager
    {
        private HelloWorldMIPPluginUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public HelloWorldMIPPluginItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            return new HelloWorldMIPPluginAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((HelloWorldMIPPluginAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, _kind, fqid.ObjectId);
            return item;
        }
