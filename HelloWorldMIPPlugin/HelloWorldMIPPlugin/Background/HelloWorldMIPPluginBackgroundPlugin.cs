...
namespace HelloWorldMIPPlugin.Background
{
    /// <summary>
    ...
    /// </summary>
    public class HelloWorldMIPPluginBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return HelloWorldMIPPluginDefinition.HelloWorldMIPPluginBackgroundPlugin; }
        }
        ...
        {
            get { return "HelloWorldMIPPlugin BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "HelloWorldMIPPlugin Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "HelloWorldMIPPlugin background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "HelloWorldMIPPlugin background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
