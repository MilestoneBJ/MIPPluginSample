...
namespace HelloWorldMIPPlugin.Client
{
    ...
    /// </summary>
    public class HelloWorldMIPPluginOptionsDialogPlugin : OptionsDialogPlugin
    {
        ...
        {
            LoadProperties(true);
            return new HelloWorldMIPPluginOptionsDialogUserControl();
        }
        ...
        {
            get { return HelloWorldMIPPluginDefinition.HelloWorldMIPPluginOptionsDialog; }
        }
        ...
        {
            get { return "HelloWorldMIPPlugin Options"; }
        }
