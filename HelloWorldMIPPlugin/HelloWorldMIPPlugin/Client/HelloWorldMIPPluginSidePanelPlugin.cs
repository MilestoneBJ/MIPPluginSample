...
namespace HelloWorldMIPPlugin.Client
{
    ...
    /// </summary>
    public class HelloWorldMIPPluginSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        {
            return new HelloWorldMIPPluginSidePanelUserControl();
        }
        ...
        {
            get { return HelloWorldMIPPluginDefinition.HelloWorldMIPPluginSidePanel; }
        }
        ...
        {
            get { return "HelloWorldMIPPlugin Side panel"; }
        }
