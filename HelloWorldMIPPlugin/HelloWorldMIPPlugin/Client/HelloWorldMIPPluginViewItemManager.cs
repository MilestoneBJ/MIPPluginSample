...
namespace HelloWorldMIPPlugin.Client
{
    ...
    /// </summary>
    public class HelloWorldMIPPluginViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public HelloWorldMIPPluginViewItemManager() : base("HelloWorldMIPPluginViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(HelloWorldMIPPluginDefinition.HelloWorldMIPPluginPluginId, null, HelloWorldMIPPluginDefinition.HelloWorldMIPPluginKind);
        ...
        {
            return new HelloWorldMIPPluginViewItemUserControl(this);
        }
        ...
        {
            return new HelloWorldMIPPluginPropertiesUserControl(this);
        }
