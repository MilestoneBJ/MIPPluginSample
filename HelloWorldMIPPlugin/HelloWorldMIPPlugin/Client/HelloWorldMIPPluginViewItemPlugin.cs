...
namespace HelloWorldMIPPlugin.Client
{
    ...
    /// </summary>
    public class HelloWorldMIPPluginViewItemPlugin : ViewItemPlugin
    {

        public HelloWorldMIPPluginViewItemPlugin()
        {
        }
        ...
        {
            get { return HelloWorldMIPPluginDefinition.HelloWorldMIPPluginViewItemPlugin; }
        }


        public override System.Drawing.Image Icon
        {
            get { return HelloWorldMIPPluginDefinition.TreeNodeImage; }
        }
        ...
        {
            return new HelloWorldMIPPluginViewItemManager();
        }
