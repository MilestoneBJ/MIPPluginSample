...
namespace HelloWorldMIPPlugin.Client
{
    ...
    /// </summary>
    public partial class HelloWorldMIPPluginViewItemUserControl : ViewItemUserControl
    {
        #region Component private class variables

        private HelloWorldMIPPluginViewItemManager _viewItemManager;
        ...
        /// <summary>
        /// Constructs a HelloWorldMIPPluginViewItemUserControl instance
        /// </summary>
        public HelloWorldMIPPluginViewItemUserControl(HelloWorldMIPPluginViewItemManager viewItemManager)
        {
