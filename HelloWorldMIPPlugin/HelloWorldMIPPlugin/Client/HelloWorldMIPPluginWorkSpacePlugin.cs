...
{
    public class HelloWorldMIPPluginWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return HelloWorldMIPPluginDefinition.HelloWorldMIPPluginWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new HelloWorldMIPPluginWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
